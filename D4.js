...
const crazyDiff = function(givNum, num19) {
       
    let result 
     if(givNum > 19) {
 
     console.log(3 * Math.abs(givNum - num19))
    } else {
     console.log(Math.abs(givNum - num19))
 
     }
     return result
     }
     console.log(crazyDiff(27, 19))
...
let givenString = "this is my given string"
...
let newGivenString = "this is overwhelming"
const cutString = function (newGivenString)
{
let result = newGivenString.slice(2)
}
